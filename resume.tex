...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Lenguajes:  & {\skill{ Python, R, PHP, Java, JavaScript, NodeJS, TypeScript, SQL, PL/SQL, HTML, CSS}} \\
		Frameworks:  & {\skill{ Django, Fast Api, React, Astro, Spring, Spring Boot.}} \\
		Bases de Datos:  & {\skill{ MySQL, PostgreSQL, SQL Server, SQLite, Redis.}} \\
		Tecnologías / Herramientas: \hspace{0.05cm} & {\skill{ Linux, Docker, Caprover, pipenv, Celery, npm, Git, GitHub Actions, Api Rest, Kafka.}} \\
		Practicas:  & {\skill{ Agile, Principios SOLID,, Microservicios, DDD, Testing, Event Driven Architecture.}} \\
		\end{tabular}}}
	{}
	{}
	{}
...
\begin{cventries}
	...
	{\begin{cvitems}
		...
		\item {Diseñar y Desarrollar una plataforma para la gestión de datos administrativos y clinicos para empresas de Radiografías Dentales. Agilizando el proceso de atención y gestion de pacientes en un 50\%, utilizando tecnologías como php y java con Spring Boot.}
